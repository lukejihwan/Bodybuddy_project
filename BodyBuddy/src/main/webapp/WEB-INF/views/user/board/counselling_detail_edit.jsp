...
<%
	...
	String detailViewURI = "/board/counselling_detail_view/";
	int idx = board.getCounselling_board_idx();
%>
<!DOCTYPE html>
	...
	<div class="space-medium">
		<div class="container">
			...
			<div class="row">
				<div class="col">
					<form id="form1">
						<input type="hidden" name="counselling_board_idx" class="for-send" value="<%= board.getCounselling_board_idx() %>">
		...
		Swal.fire({
			  ...
			  cancelButtonText: '아니요, 수정하지 않겠습니다'
				...
				if (result.isConfirmed) {
					...
					$.ajax({
						url:"/rest/board/counsellingBoard",
						type:"PUT",
