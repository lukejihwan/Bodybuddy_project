                        ...
                        <div class="row">
                            <div class="col-md-8 col-sm-12">
                                <div class="row">
                                    ...
                                    <img src="/resources/user/images/vegan1.png" class="" alt="vegan1">
                                    <p></p>
                                    <div class="mb30">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="side-nav mb30  ">
                                            <ul class="listnone sidenav">
                                                ...
                                                <li class="active"> <a href="/diet/info_vegan"><i class="icon-5 service-sidenav-icon"></i><span class="sidenav-text">비건식</span> </a></li>
