...
public class RestExrController {
	...
	// 이미지 삭제
	@DeleteMapping("/exr/notice_img/{exr_notice_idx}")
	public ResponseEntity<Msg> delImg(@PathVariable("exr_notice_idx") int exr_notice_idx) throws ExrCategoryException{
